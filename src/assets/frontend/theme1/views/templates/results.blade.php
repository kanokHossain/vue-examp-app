            ...
            <div class="page-content">
                <div class="page-search-box mb-2">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a href="#" class="btn btn-primary btn-print" onclick="printDiv('printableArea')" style="width: 25% !important;"><i class="fa fa-print ml-1"></i>Print</a>
                            </div>
                        </div>
                ...
                <?php if (count($search_results) > 0) { ?>
                    <div class="result-view result-div-class mb-40" id="printableArea">
                    <?php } else { ?>
                        <div class="result-view d-none mb-40" id="printableArea">
                        <?php } ?>
                        <div class="container">
                            <div class="result-school-header text-center">
