...
<div class="row" style="margin-bottom: 40px;">
    <div class="col-md-12">
        <form action="" class="form-inline" method="GET">
            <input type="text" class="form-control col-sm-3 mb-2 mr-sm-2" id="event" name="event"
            ...
            <button type="button" class="btn btn-primary mb-2 event-submit-btn col-sm-2 searchBtn">Go</button>
        </form>
    </div>
</div>
