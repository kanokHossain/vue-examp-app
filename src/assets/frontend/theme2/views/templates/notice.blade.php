    ...
    <div class="row" style="margin-bottom: 40px;">
        <div class="col-md-12">
            <form action="" class="form-inline" method="GET">
                <input type="text" class="form-control col-sm-3 mb-2 mr-sm-2" id="notice" name="notice"
                       placeholder="Search Notice">

                <input type="text" class="form-control col-sm-3 mb-2 mr-sm-2 datepicker" id="from_date" name="from_date"
                       placeholder="From">

                <input type="text" class="form-control col-sm-3 mb-2 mr-sm-2 datepicker" id="to_date" name="to_date"
                       placeholder="To">

                <button type="button" class="btn btn-primary mb-2 event-submit-btn col-sm-2 noticeBtn">Go</button>
            </form>
        </div>
    </div> 
</div>
