            ...
            <div class="page-content">
                <div class="page-search-box mb-2">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a href="javascript:void(0)" class="btn btn-print" onclick="printDiv('printableArea')" style="background-color: #008C99; color: #fff;"><i class="fa fa-print ml-1" style="margin-right: 5px;"></i>Print</a>
                            </div>
                        </div>
